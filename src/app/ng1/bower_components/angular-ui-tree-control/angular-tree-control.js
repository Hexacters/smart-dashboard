        ...
        .directive( 'treecontrol', ['$compile', function( $compile ) {
            ...
            return {
                ...
                controller: ['$scope', function( $scope ) {
                    ...
                    var childrenField = angular.element('treecontrol').attr('children-field')?angular.element('treecontrol').attr('children-field'):'children';
                    $scope.options = $scope.options || {};
                    ensureDefault($scope.options, "multiSelection", false);
                    ensureDefault($scope.options, "nodeChildren", childrenField);
                    ...
                    $scope.callbackEvent = function(nodeData){
                    	if(angular.element('treecontrol').attr('click-event'))
                         	return eval("$scope."+angular.element('treecontrol').attr('click-event')+"(nodeData)");
                    }
                    ...
                    var template =
                        '<ul '+classIfDefined($scope.options.injectClasses.ul, true)+'>' +
                            ...
                            '<div ng-if="headClass(node) !=\'tree-leaf\'" class="tree-label '+classIfDefined($scope.options.injectClasses.label, false)+'" ng-class="[selectedClass(), unselectableClass()]" ng-click="selectNodeLabel(node);selectNodeHead(node)" tree-transclude></div>' +
                            '<div ng-if="headClass(node) ==\'tree-leaf\'" class="tree-label '+classIfDefined($scope.options.injectClasses.label, false)+'" ng-class="[selectedClass(), unselectableClass()]" ng-click="selectNodeLabel(node);selectNodeHead(node);callbackEvent(node);" tree-transclude></div>' +
