...
angular.module('ui.calendar', [])
  ...
  .controller('uiCalendarCtrl', ['$scope', 
      ...
      this.eventFingerprint = function(e) {
        ...
        var start = moment.isMoment(e.intervalStart) ? e.intervalStart.unix() : (e.intervalStart ? moment(e.intervalStart).unix() : '');
        var end =   moment.isMoment(e.intervalEnd)   ? e.intervalEnd.unix()   : (e.intervalEnd   ? moment(e.intervalEnd).unix()   : '');
